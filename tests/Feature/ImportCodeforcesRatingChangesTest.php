...
class ImportCodeforcesRatingChangesTest extends TestCase
{
    public function test_codeforces_rating_change_import_claims_and_syncs_each_contest(): void
    {
        ...
        $this->mock(CodeforcesAdapter::class, function ($mock) use ($change): void {
        ...
        $importer = app(RatingChangeImporter::class, [
            ...
            'adapter' => app(CodeforcesAdapter::class),
        ]);
        ...
        $this->assertSame('codeforces', $contestRatingChangeQuery->values['metadata']['platform']);
        $this->assertSame('1840', $contestRatingChangeQuery->values['metadata']['contest_platform_id']);
